...
def run_90_day_test():
    ...
    print(f"\n{'='*80}")
    print(f"GRAND TOTAL:")
    print(f"  Starting: ${total_starting:.2f}")
    print(f"  Ending:   ${total_ending:.2f}")
    print(f"  Profit:   ${total_ending - total_starting:+.2f}")
    print(f"  Return:   {(total_ending - total_starting) / total_starting * 100:+.1f}%")
