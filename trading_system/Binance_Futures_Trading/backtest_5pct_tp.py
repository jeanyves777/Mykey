#!/usr/bin/env python3
"""
Backtest with 5% TP for BNB, ETH, DOT
"""
...
def run_5pct_tp_test():
    """Test with 5% TP for selected pairs"""
    BACKTEST_DAYS = 90
    symbols = ["BNBUSDT", "ETHUSDT", "DOTUSDT"]

    print("="*80)
    print(f"BACKTEST WITH 5% TP - {BACKTEST_DAYS} DAYS")
    print("="*80)
    print("TP ROI: 5% (instead of 8%)")
    print("="*80)
