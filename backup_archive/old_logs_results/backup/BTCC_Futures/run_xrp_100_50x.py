#!/usr/bin/env python3
"""
$100 Capital XRPUSDT 50x Leverage - 7 Day Backtest
===================================================
Higher leverage for more profit, accepting up to 25% DD
"""
...
print("=" * 100)
print("$100 CAPITAL - XRPUSDT @ 50x LEVERAGE - 7 DAY BACKTEST")
print("=" * 100)
print()
print("Config: TP 1.0% | SL 10% | Leverage 50x | Position Size 10% ($10)")
print("Target: Up to 25% Drawdown acceptable")
print("=" * 100)
print(flush=True)
...
# Settings - 50x LEVERAGE
LEVERAGE = 50
TP_PCT = 1.0 / 100
SL_PCT = 10.0 / 100
POS_SIZE = 0.10  # 10% of account
MAINT_MARGIN = 0.005
...
for i in range(100, min(duration, len(df))):
    ...
    if position:
        ...
        # Check liquidation (at 50x, ~2% move = liquidation)
        ...
        if direction == 1:
            if high[i] >= tp_price:
                ...
                balance += pnl
                curr_dd = (max_balance - balance) / max_balance * 100 if balance < max_balance else 0
    ...
    if position is None:
        ...
        if signal != 0:
            ...
            curr_dd = (max_balance - balance) / max_balance * 100 if balance < max_balance else 0
            print(f"{i:>6} {'OPEN':<8} {dir_str:<6} {entry:>10.4f} {'---':>10} {'---':>10} ${balance:>11.2f} {curr_dd:>7.1f}% TP:{tp_price:.4f} LIQ:{liq_price:.4f}")
...
print()
print("=" * 100)
print("FINAL RESULTS - $100 CAPITAL @ 50x XRPUSDT")
print("=" * 100)
...
print()
print("=" * 100)
print("COMPARISON: 20x vs 50x LEVERAGE")
print("=" * 100)
print("""
  20x Leverage:
  - Win per trade: ~$2.19
  ...
  50x Leverage:
  - Win per trade: ~$5.50 (2.5x more)
  - Expected return: ~85% (2.5x more)
  - Risk: Liquidation at ~2% adverse move
  - Higher DD possible
""")
print("=" * 100)
