"""
OPTIMIZED FOREX STRATEGY - PAPER TRADING CONFIG V2
===================================================
...
- backtest_optimized_strategy.py
- run_optimized_forex_paper.py
"""
...
def calculate_position_size(instrument: str, current_price: float) -> int:
    ...
    if instrument in ['EUR_USD', 'GBP_USD', 'AUD_USD', 'NZD_USD']:
        ...
        # For XXX/JPY crosses, position size depends on the base currency rate
        # ~10,000 units for $1/pip (approximate)
        return 10000
        ...
        # EUR/GBP: pip value = 0.0001 * units / GBP_USD rate
        # For $1/pip with GBP/USD ~1.27: units = 10000 * 1.27 = ~12,700
        return 12700
    elif instrument == 'AUD_CHF':
        # AUD/CHF: pip value = 0.0001 * units / USD_CHF rate
        # For $1/pip with USD/CHF ~0.90: units = 10000 / 0.90 = ~11,000
        return 11000
    elif instrument == 'EUR_CAD':
        # EUR/CAD: pip value = 0.0001 * units / USD_CAD rate
        # For $1/pip with USD/CAD ~1.43: units = 10000 * 1.43 = ~14,300
        return 14300
    else:
        return 10000
...
def print_config_info():
    ...
    print("=" * 80)
    print("OPTIMIZED FOREX STRATEGY V2 - 14-STRATEGY MULTI-STAGE OPTIMIZATION")
    print("=" * 80)
